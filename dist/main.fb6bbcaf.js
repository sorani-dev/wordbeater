...
Object.freeze(LEVELS); // To change level

var currentLevel = LEVELS.easy;
var time = 5; // time to type

var score = 0; // player score

var isPlaying; // is the game going on?
...
var difficutySelect = document.querySelector('#difficulty');
var words = ['hat', 'river', 'lucky', 'statue', 'generate', 'stubborn', 'cocktail', 'runaway', 'joke', 'developer', 'establishment', 'hero', 'javascript', 'nutrition', 'revolver', 'echo', 'siblings', 'investigate', 'horrendous', 'symptom', 'laughter', 'magic', 'master', 'space', 'definition']; // Initialize game

var init = function init() {
  // Show number of seconds
  seconds.innerHTML = currentLevel; // load word from array

  showWord(words); // Start matching on input

  wordInput.addEventListener('input', startMatch); // Select level difficulty
...
function selectDifficulty() {//   const value = difficutySelect.value
...
function countdown() {
  console.log('countdown'); // Make sure the time is not run out
...
function setScore(score) {
  var oldScore = window.localStorage.getItem('wordBeater');
  var newScore;
